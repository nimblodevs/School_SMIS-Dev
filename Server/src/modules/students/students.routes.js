...
router.post('/:id/parents', authorizeRoles('ADMIN', 'SUPER_ADMIN', 'STAFF'), StudentController.linkParent);
router.delete('/:id/parents/:parentId', authorizeRoles('ADMIN', 'SUPER_ADMIN', 'STAFF'), StudentController.unlinkParent);
router.patch(
