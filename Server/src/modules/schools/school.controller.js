...
export class SchoolController {
    static async create(req, res, next) {
        try {
            ...
            const school = await SchoolService.create(validation.data, req.user, {
                ipAddress: req.ip,
    ...
    static async current(req, res, next) {
        try {
            if (!req.user.schoolId)
                throw new BadRequestError('The current user is not assigned to a school');
    ...
    static async update(req, res, next) {
        try {
            ...
            if (!params.success)
                throw new BadRequestError('Validation error', params.error.format());
