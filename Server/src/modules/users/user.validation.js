...
const baseProvisionSchema = z
    ...
    .refine((value) => Boolean(value.nationalIdNumber) !== Boolean(value.passportNumber), {
        message: 'Provide exactly one national ID number or passport number',
